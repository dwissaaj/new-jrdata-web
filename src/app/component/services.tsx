        ...
        <h1 className={'text-white text-2xl font-jb '}>Services</h1>
          <div className={'grid grid-cols-3 gap-3 '}>
              <div className={'grid grid-rows-3 p-4 gap-0 bg-gray-800 hover:bg-gray-900  shadow-md shadow-slate-900 hover:shadow-lg hover:shadow-blueish'}>
                  ...
                  <h3 className={'text-white font-mulish font-semibold'}>Language</h3>
              ...
              <div className={'grid grid-rows-3 p-4 gap-0 bg-gray-800 hover:bg-gray-900  shadow-md shadow-slate-900 hover:shadow-lg hover:shadow-blueish'}>
                ...
                <h3 className={'text-white font-mulish font-semibold '}>Front End Development</h3>
              ...
              <div className={'grid grid-rows-3 p-4 gap-0 bg-gray-800 hover:bg-gray-900 shadow-md shadow-slate-900 hover:shadow-lg hover:shadow-blueish'}>
                  ...
                  <h3 className={'text-white font-mulish font-semibold'}>Data Analyst</h3>
              ...
              <div className={'grid grid-rows-3 p-4 gap-0 bg-gray-800 hover:bg-gray-900  shadow-md shadow-slate-900 hover:shadow-lg hover:shadow-blueish'}>
                  ...
                  <h3 className={'text-white font-mulish font-semibold'}>Data Scientist</h3>
              ...
              <div className={'grid grid-rows-3 p-4 gap-0 bg-gray-800 hover:bg-gray-900  shadow-md shadow-slate-900 hover:shadow-lg hover:shadow-blueish'}>
                  ...
                  <h3 className={'text-white font-mulish font-semibold'}>Digital Marketing</h3>
              ...
              <div className={'grid grid-rows-3 p-4 gap-0 bg-gray-800 p-4 gap-3 disabled'}>
                  ...
                  <h3 className={'text-white font-mulish font-semibold '}>Back End Development</h3>
